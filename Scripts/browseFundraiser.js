let browseFundraiserData =
  JSON.parse(localStorage.getItem("browse_fundraiser_data")) || [];

let browseFundraiserDataDefault = [
  {
  ...
  {
    img: "https://kettocdn.gumlet.io/media/campaign/445000/445343/image/wid60f6ea7fc6789.jpeg?w=300&dpr=1.1",
    title: "BACK TO SCHOOL",
    by: "Vidya Bhawan Society",
    AmountRaised: 2254717,
  ...
  },
  {
    ...
    title: "You Can Help India's Children Continue Their Education #LetChildrenBeChildren",
    icon: "",
  ...
  },
  {
    ...
    title: "Support For Family Of Late Sakila Tudu, An Alumni From NIT Rourkela",
    icon: "",
  ...
  },
  {
    ...
    title: "We Need Your Help In Sustaining This Community Center To Provide Daily Meals And Education For Children",
    icon: "",
    by: "Manjusha Varma",
    AmountRaised: 577614,
  ...
  },
  {
    ...
    title: "Masjid For 1000 Of Muslim's And A Education Centre For Dawa'ah Of Islam",
    icon: "",
    by: "Mariya Mahfooz",
    AmountRaised: 280767,
    AmountNeeded: 350000,
  ...
  },
  {
    ...
    title: "10 Lac Seed Ball Plantation In Mumbai - Yi Mumbai's Tree Plantation Drive",
    icon: "",
    by: "Mitanshu Shah ",
    AmountRaised: 85911,
    AmountNeeded: 3000000,
  ...
  },
  {
    ...
    title: "1SAVE LIFE CHARITABLE TRUST (R) - Emergency Fund For Causes From Jul 2022",
    icon: "",
    by: "Arjun Bhandarkar",
    AmountRaised: 714240,
    AmountNeeded: 1000000,
...
disp(browseFundraiserDataDefault);
...
category.addEventListener("change", function (event) {
  ...
  if (category.value == "") {
    ...
    let res = browseFundraiserDataDefault.filter(function (el) {
...
let listCategory =document.querySelectorAll("li")
for(let i=0;i<listCategory.length;i++) {
  
  listCategory[i].addEventListener("click", function (event) {
    event.preventDefault();

    if(listCategory[i].innerText=="All Categories"){
      disp(browseFundraiserDataDefault);
    }
    else{
    let res = browseFundraiserDataDefault.filter(function (el) {      
      return el.category == listCategory[i].innerText;
    });
    disp(res);
    }
})
...
let search = document
  .querySelector("#searchMidButton")
  .addEventListener("click", function () {
    let input = document.querySelector("#searchMid");
    let res = browseFundraiserDataDefault.filter(function (el) {
      return el.title.toLowerCase().includes(input.value.toLowerCase()) || el.by.toLowerCase().includes(input.value.toLowerCase());
    });
    disp(res);
  });
...
function disp(res) {
  ...
  res.forEach(function (el) {
    ...
    if (el.DaysLeft != "Fundraiser Ended") {
      DaysLeft.innerText = `${el.DaysLeft || 90} days left`;
    } else {
      DaysLeft.innerText = el.DaysLeft;
    }

    let supporters = document.createElement("p");
    supporters.innerText = (el.supporters || 0) + " Supporters";

    divchild.append(DaysLeft, supporters);
    div.append(title, by, Amount, divchild);
    divParent.append(img, div);

    document.querySelector("#innerData").append(divParent);
  });
}
